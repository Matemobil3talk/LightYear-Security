...
class Antinuke(commands.Cog):
    ...
    async def on_member_ban(self, guild, member):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
             ...
             await guild.unban(user=member, reason="LightYear | Auto Recovery")
             await logs.user.ban(reason=f"LightYear | Anti Ban")
    ...
    async def on_guild_emojis_update(self, emoji):
            ...
            logs = logs[0]
            await logs.user.ban(reason=f"LightYear | Anti Emoji Update")
    ...
    async def on_guild_emoji_create(self, emoji):
            ...
            logs = logs[0]
            await emoji.delete()
            await logs.user.ban(reason=f"LightYear | Anti Emoji Create")
    ...
    async def on_guild_emojis_delete(self, emoji):
            ...
            logs = logs[0]
            await logs.user.ban(reason=f"LightYear | Anti Emoji Delete")
    ...
    async def on_sticker_create(self, sticker):
            ...
            await logs.user.ban(reason=f"LightYear | Anti Sticker Create")
    ...
    async def on_sticker_update(self, sticker):
            ...
            logs = logs[0]
            await logs.user.ban(reason=f"LightYear | Anti Update Create")
    ...
    async def on_sticker_delete(self, sticker):
            ...
            logs = logs[0]
            await logs.user.ban(reason=f"LightYear | Anti Sticker Update")      
    ...
    async def on_member_remove(self, member, guild):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
             ...
             await logs.user.ban(reason=f"LightYear | Anti Kick")
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
             ...
             await logs.user.ban(reason=f"LightYear | Anti Prune")
    ...
    async def on_guild_channel_create(self, channel):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == 695090470908330079 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await channel.delete(reason="LightYear | Auto Recovery")
              await logs.user.ban(reason=f"LightYear | Anti Channel Create")  
    ...
    async def on_guild_channel_delete(self, channel):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await channel.clone(reason="LightYear | Auto Recovery")
              await logs.user.ban(reason=f"LightYear | Anti Channel Delete")
    ...
    async def on_guild_channel_update(self, before, after):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await after.edit(name=f"{before.name}", nsfw=f"{before.nsfw}", reason="LightYear | Auto Recovery")
              await logs.user.ban(reason=f"LightYear | Anti Channel Update")
    ...
    async def on_guild_role_create(self, role):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await role.delete(reason="LightYear | Auto Recovery")
              await logs.user.ban(reason=f"LightYear | Anti Role Create")
    ...
    async def on_guild_role_delete(self, role):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await logs.user.ban(reason=f"LightYear | Anti Role Delete")
    ...
    async def on_guild_role_update(self, before, after):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await after.edit(name=f"{before.name}",  hoist=f"{before.hoist}", mentionable=f"{before.mentionable}", reason="LightYear | Auto Recovery")
              await logs.user.ban(reason=f"LightYear | Anti Role Update")
    ...
    async def on_guild_update(self, before, after):
      with open('whitelisted.json') as f:
            ...
            if logs.user.id == 877922339382243328 or logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await logs.user.ban(reason="LightYear | Anti Guild Update")
    ...
    async def on_member_unban(self, guild, member):
      with open('whitelisted.json') as f:
            ...
            logs = logs[0]
            if logs.user.id == 877922339382243328 or logs.user.id == 918527734748164128 or str(logs.user.id) in whitelisted[str(guild.id)]:
              pass
            else:
              await logs.user.ban(reason=f"LightYear | Anti Unban")
    ...
    async def on_webhooks_update(self, webhook):
      with open('whitelisted.json') as f:
            ...
            if str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await logs.user.ban(reason=f"LightYear | Anti Webhook Update")
    ...
    async def on_webhooks_create(self, channel):
      with open('whitelisted.json') as f:
            ...
            if str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await logs.user.ban(reason=f"LightYear | Anti Webhook Create")
    ...
    async def on_webhooks_delete(self, webhook):
      with open('whitelisted.json') as f:
            ...
            if str(logs.user.id) in whitelisted[str(guild.id)]:
              ...
              await logs.user.ban(reason=f"LightYear | Anti Webhook Delete")
    ...
    async def on_member_join(self, member):
      with open('whitelisted.json') as f:
        ...
        if logs.user.id == guild.owner.id or str(logs.user.id) in whitelisted[str(guild.id)]:
         ...
         if member.bot:
          await member.ban(reason="LightYear | Anti Bot Add")
          await logs.user.ban(reason=f"LightYear | Anti Bot Add")
